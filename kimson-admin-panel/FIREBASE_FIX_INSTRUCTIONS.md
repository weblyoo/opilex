...
3. In [Firebase Console](https://console.firebase.google.com/project/opilex-2a79f) → **Firestore Database** → **Rules**, paste and click **Publish**.
