...
1. **Open Google Cloud Console:**
   [Create Bucket](https://console.cloud.google.com/storage/browser?project=kimson-3373e)
...
If `kimson-3373e-storage` is taken, you can use:
- `kimson-storage`
...
- [ ] Create bucket in Google Cloud Console (name: `kimson-3373e-storage`)
- [ ] Wait 2-3 minutes
