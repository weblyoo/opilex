# 🔌 Opilex Wire QR Code Testing Guide
...
### **Step 2: Test in Opilex App**
1. **Open Opilex App** → Login → Dashboard
2. **Navigate to Scan**: 
...
```json
{
  "productId": "OPILEX-WIRE-2024-001",
  "batchId": "BATCH-A001",
...
```json
{
  "productId": "OPILEX-WIRE-2024-007",
...
```json
{
  "productId": "OPILEX-WIRE-2024-006",
  "batchId": "BATCH-E001",
