  ...
  const socialPlatforms = [
    {
      ...
      followers: '12.5K',
      url: 'https://facebook.com/opilexindustries',
      color: '#1877F2',
      icon: 'social-media',
    },
    {
      ...
      followers: '8.2K',
      url: 'https://instagram.com/opilexindustries',
      color: '#E4405F',
      icon: 'social-media',
    },
    {
      ...
      followers: '5.8K',
      url: 'https://linkedin.com/company/opilexindustries',
      color: '#0A66C2',
      icon: 'social-media',
    },
    {
      ...
      followers: '15.3K',
      url: 'https://youtube.com/opilexindustries',
      color: '#FF0000',
      icon: 'watch-tutorial',
    },
    {
      ...
      followers: '6.7K',
      url: 'https://twitter.com/opilexindustries',
      color: '#1DA1F2',
      icon: 'social-media',
    },
  ];
  ...
  const communityFeatures = [
    {
      ...
      description: 'Show off your electrical installations using Opilex products',
      action: 'Upload Photo',
    },
    {
      id: '2',
    ...
    },
    {
      ...
      description: 'Read and write reviews for Opilex products',
      action: 'Write Review',
    },
    {
      id: '4',
