      ...
      >
        ...
        <View style={styles.headerSection}>
          ...
          <Text style={[styles.subtitle, { color: theme.colors.accent }]}>
            Master the OPILEX app with our comprehensive guides
          </Text>
          <View style={[
            styles.statusBadge,
            {
        ...
        <View style={[
          ...
          <Text style={[styles.descriptionText, { color: theme.colors.accent }]}>
            We're creating step-by-step video tutorials and interactive guides to help you make the most of every feature in the OPILEX app.
          </Text>
        </View>
