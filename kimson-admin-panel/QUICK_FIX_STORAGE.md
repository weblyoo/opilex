...
1. **Open Google Cloud Console:**
   [Create Storage Bucket](https://console.cloud.google.com/storage/browser?project=kimson-3373e)
...
3. **Billing:** Check if billing is required (though free tier shouldn't need it)
   - https://console.firebase.google.com/project/kimson-3373e/settings/billing
