# Opilex Admin Panel – Deploy to Netlify
...
1. Connect repo `weblyoo/opilex-admin-panel` to Netlify.
2. Set **Base directory:** `opilex-admin-panel`
...
- Workflow builds `opilex-admin-panel` and deploys `opilex-admin-panel/dist` to Netlify.
