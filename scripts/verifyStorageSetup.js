...
async function verify() {
  ...
  try {
    ...
    try {
      ...
      console.log(`   Bucket: kimson-3373e-storage`);
    ...
    if (error.code === 'storage/bucket-not-found' || error.message.includes('bucket')) {
      ...
      console.log('\n💡 Make sure:');
      console.log('   1. Bucket "kimson-3373e-storage" exists in Google Cloud Console');
      console.log('   2. Bucket is in project: kimson-3373e');
