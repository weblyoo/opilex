...
const firebaseConfig = {
  ...
  storageBucket: "kimson-3373e-storage", // Try custom bucket first
...
async function checkStorage() {
  ...
  let bucketName = 'kimson-3373e-storage';
  let storage = null;
  let app = null;
  ...
  try {
    ...
    if (error.code === 'storage/unknown' || error.code === 'storage/bucket-not-found') {
      ...
      try {
        ...
        console.log('   Change: storageBucket: "kimson-3373e.firebasestorage.app"\n');
        process.exit(0);
