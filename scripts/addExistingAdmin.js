...
if (!email) {
  ...
  console.log('\nUsage: node scripts/addExistingAdmin.js <email> [password]');
  console.log('Example: node scripts/addExistingAdmin.js admin@kimson.com Admin@123456');
  process.exit(1);
}
...
async function addExistingAdmin() {
  try {
    ...
    console.log('   https://console.firebase.google.com/project/kimson-3373e/firestore/data/~2Fadmins~2F' + userId);
