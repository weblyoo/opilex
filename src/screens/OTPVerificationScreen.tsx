      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        >
          ...
          <View style={styles.cardContainer}>
            <View style={[styles.otpCard, { backgroundColor: '#1a1a1a' }]}>
              ...
              <View style={styles.formSection}>
                  ...
                  {otp.map((digit, index) => (
                    <TextInput
                      ...
                      style={[
                        styles.otpInput,
                        { 
                          borderColor: digit ? '#FFFFFF' : 'rgba(51, 51, 51, 0.3)',
                ...
                {/* Verify Button */}
                <TouchableOpacity
                  style={[styles.verifyButton, { backgroundColor: '#FFFFFF' }]}
                  onPress={handleVerifyOTP}
                  disabled={isLoading}
                  activeOpacity={0.8}
                >
                  <Text style={[styles.verifyButtonText, globalTextStyles.button, { color: '#1a1a1a' }]}>
