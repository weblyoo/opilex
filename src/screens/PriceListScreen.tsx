...
const PriceListScreen: React.FC<Props> = ({ navigation }) => {
  ...
  const galleryItems = [
    { id: '1', title: 'Price List 1', image: require('../../assets/product1.jpeg') },
    { id: '2', title: 'Price List 2', image: require('../../assets/product2.jpeg') },
    { id: '3', title: 'Price List 3', image: require('../../assets/product3.jpeg') },
    { id: '4', title: 'Price List 4', image: require('../../assets/product4.jpeg') },
    { id: '5', title: 'Price List 5', image: require('../../assets/product1.jpeg') },
    { id: '6', title: 'Price List 6', image: require('../../assets/product2.jpeg') },
  ];
  ...
  const handleOpenPDF = async () => {
    ...
    // For local PDF files in assets, we need to use a URL or file system
    // Option 1: If you have a hosted PDF URL
    const pdfUrl = 'https://discontented-owl.static.domains/312d3d58719d2fdd157513f4d15e688c.pdf'; // Replace with your actual PDF URL
    
    // Option 2: For local files, you would need expo-file-system
    // For now, we'll try to open with a sample URL
    ...
    try {
      ...
      if (supported) {
        ...
        Alert.alert(
          'Cannot Open PDF',
          'Please install a PDF viewer app to view price lists.',
          [{ text: 'OK' }]
        );
      }
    } catch (error) {
        ...
        <View style={styles.modalOverlay}>
          <View style={[
            ...
            <View style={styles.pdfModalIconContainer}>
              <View style={[
                ...
                <View style={[
                  ...
                  <Icon name="info" size={48} color={isDark ? '#000000' : '#FFFFFF'} strokeWidth={3} />
                </View>
              </View>
            </View>
            ...
            <Text style={[styles.pdfModalMessage, { color: theme.colors.accent }]}>
              Ready to view the latest price list in PDF format
            </Text>
            ...
            <View style={[
              ...
              <View style={styles.pdfModalDetailRow}>
                <View style={[
                  ...
                  <Icon name="price-list" size={24} color={isDark ? '#000000' : '#FFFFFF'} strokeWidth={2.5} />
                </View>
                <View style={styles.pdfModalDetailTextContainer}>
                  ...
                  <Text style={[styles.pdfModalDetailDescription, { color: theme.colors.accent }]}>
                    All product prices and specifications
                  </Text>
                </View>
              </View>
            </View>
