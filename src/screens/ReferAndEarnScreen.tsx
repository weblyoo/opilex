...
const ReferAndEarnScreen: React.FC<Props> = ({ navigation }) => {
  ...
  const referralCode = `KIMSON${user?.id.substring(0, 6).toUpperCase() || 'DEMO123'}`;
  const referralLink = `https://kimson.app/refer/${referralCode}`;
