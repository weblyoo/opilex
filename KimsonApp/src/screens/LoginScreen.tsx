      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        >
          ...
          <View style={styles.cardContainer}>
            <View style={[styles.loginCard, { backgroundColor: '#000000' }]}>
              ...
              <View style={styles.formSection}>
                ...
                <View style={styles.inputGroup}>
                  ...
                  <View style={[styles.inputContainer, { 
                    borderColor: errors.phoneNumber ? '#F44336' : 'rgba(255, 255, 255, 0.2)',
                    backgroundColor: '#000000' 
                  }]}>
                    <Text style={[styles.countryPrefix, globalTextStyles.body, { color: '#CCCCCC' }]}>+91</Text>
                    <View style={[styles.inputSeparator, { backgroundColor: 'rgba(255, 255, 255, 0.2)' }]} />
                    <TextInput
                ...
                {/* Login Button */}
                <TouchableOpacity
                  style={[styles.loginButton, { backgroundColor: '#000000', borderWidth: 1, borderColor: 'rgba(255, 255, 255, 0.3)' }]}
                  onPress={handleSendOTP}
                  disabled={Boolean(isLoading)}
                  activeOpacity={0.8}
                >
                  <Text style={[styles.loginButtonText, globalTextStyles.button, { color: '#FFFFFF' }]}>
