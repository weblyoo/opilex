...
const RegistrationScreen: React.FC<Props> = ({ navigation }) => {
  ...
  const handleNext = async () => {
    ...
    try {
      ...
      console.log('💾 [REGISTRATION] Saving userType to Firestore:', {
        selectedUserType,
        normalizedUserType,
        userId: user.id,
      });
      ...
      console.log('✅ [REGISTRATION] UserType saved successfully:', normalizedUserType);
            ...
            <View style={[styles.registrationCard, { backgroundColor: theme.colors.cardBackground }]}>
              ...
              >
                ...
                <TouchableOpacity
                  ...
                  onPress={handleNext}
                  disabled={Boolean(!selectedUserType || isLoading)}
                  activeOpacity={0.8}
                >
                  <Text style={[
