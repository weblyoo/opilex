    ...
    >
      ...
      >
        ...
        >
          ...
          <Text 
            style={[styles.helloText, globalTextStyles.h1, { color: theme.colors.text }]}
          ...
          <Text 
            style={[styles.subtitle, globalTextStyles.subtitle, { color: theme.colors.accent }]}
            allowFontScaling={false}
            selectable={false}
          >
        ...
        >
          <Text 
            style={[styles.selectorLabel, globalTextStyles.label, { color: theme.colors.text }]}
            allowFontScaling={false}
            selectable={false}
          >
            Choose Language
          ...
          >
            ...
            >
              ...
              >
                <View 
                  style={[styles.languageFlag, { backgroundColor: theme.colors.accent }]}
                  collapsable={false}
                  removeClippedSubviews={false}
                >
                  <Text 
                    style={[styles.flagText, globalTextStyles.caption]}
                    allowFontScaling={false}
                    selectable={false}
                  >
                ...
                <View 
                  style={styles.languageDetails}
                  collapsable={false}
                  removeClippedSubviews={false}
                >
                  <Text 
                    style={[styles.languageName, globalTextStyles.body, { color: theme.colors.text }]}
                    allowFontScaling={false}
                    selectable={false}
                  >
                  ...
                  <Text 
                    style={[styles.languageNative, globalTextStyles.caption, { color: theme.colors.accent }]}
                    allowFontScaling={false}
                    selectable={false}
                  >
              ...
              <View 
                style={[styles.dropdownArrow, { backgroundColor: theme.colors.accent }]}
                collapsable={false}
                removeClippedSubviews={false}
              >
                <Icon 
        ...
        >
          ...
          >
                <Text 
                  style={[styles.nextButtonText, { color: theme.colors.background }]}
                  allowFontScaling={false}
                  selectable={false}
                >
                  Next
