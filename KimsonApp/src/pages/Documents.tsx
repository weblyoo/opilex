...
export const Documents = () => {
  ...
  const Card = ({ title, meta, kind }: { title: string; meta: AdminDocMeta | null; kind: 'pricelist'|'products' }) => (
    <div className="bg-gradient-to-br from-black/90 to-black/70 border border-white/20 rounded-2xl p-6 backdrop-blur-sm glow">
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <button onClick={() => handleUpload(kind)} disabled={saving || !(kind==='pricelist' ? priceFile : productsFile)} className="px-5 py-3 bg-white text-black rounded-xl disabled:opacity-50 font-ubuntu-bold">
  ...
  return (
    <Layout>
      <div className="p-8 min-h-screen bg-gradient-to-br from-black via-black to-gray-900 animate-fadeIn space-y-8">
        <div>
