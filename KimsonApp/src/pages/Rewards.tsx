...
export const Rewards = () => {
  ...
  return (
    <div className="p-8 min-h-screen bg-black">
      ...
      <div className="bg-black border border-white/20 rounded-2xl p-6 mb-8">
        <div className="grid md:grid-cols-3 gap-4 mb-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 bg-black border border-white/20 rounded-xl text-white placeholder-white/40 focus:border-white focus:outline-none focus:ring-2 focus:ring-white/20 font-ubuntu-light"
            />
          </div>
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-4 py-3 bg-black border border-white/20 rounded-xl text-white focus:border-white focus:outline-none focus:ring-2 focus:ring-white/20 font-ubuntu-light"
            >
