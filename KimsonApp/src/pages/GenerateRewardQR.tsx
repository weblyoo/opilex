...
export const GenerateRewardQR = () => {
  ...
  const generateQRCode = async () => {
    ...
    try {
      ...
      console.log('🔖 [QR-GEN] Generating QR code:', {
        userType: userType,
  ...
  return (
    <div className="p-8 min-h-screen bg-black animate-fadeIn">
      <div className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-5 py-4 border border-white/20 rounded-xl bg-black/50 text-white placeholder-white/40 focus:border-white focus:outline-none focus:ring-2 focus:ring-white/20 font-ubuntu-light transition-all duration-300"
                min="1"
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                rows={4}
                className="w-full px-5 py-4 border border-white/20 rounded-xl bg-black/50 text-white placeholder-white/40 focus:border-white focus:outline-none focus:ring-2 focus:ring-white/20 font-ubuntu-light transition-all duration-300 resize-none"
              />
            </div>
            ...
            <button
              ...
              className="w-full bg-white text-black py-4 rounded-xl hover:bg-white/90 disabled:opacity-50 font-ubuntu-black text-base tracking-wide transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-white/30 transform"
            >
      ...
      <Modal isOpen={showModal} onClose={() => setShowModal(false)} title="Reward QR Code Generated" size="md">
        <div className="space-y-6">
          ...
          <div className="flex gap-4">
            <button
              onClick={downloadQR}
              className="flex-1 bg-white text-black py-3 rounded-xl hover:bg-white/90 font-ubuntu-black transition-all duration-300 hover:scale-105"
            >
              Download QR Code
            </button>
            <button
