...
export const QRCodeLabels = () => {
  ...
  return (
    <>
      <div className="p-8 min-h-screen bg-black print-area">
        <div className="no-print mb-10 flex items-center justify-between flex-wrap gap-4">
          ...
          <div className="flex gap-3">
            <button
              onClick={exportToCSV}
              className="px-6 py-3 bg-white text-black rounded-xl hover:bg-white/90 font-ubuntu-black transition-all duration-300 hover:scale-105 shadow-xl"
          ...
          <button
            ...
            className={`px-6 py-3 rounded-xl font-ubuntu-bold transition-all duration-300 ${
              activeTab === 'electrician'
                ...
                : 'bg-black border border-white/20 text-white/60 hover:text-white hover:border-white/40'
            }`}
          >
        ...
        {currentCodes.length === 0 ? (
          ...
          <>
            {/* Export Info Banner */}
            <div className="no-print bg-white/10 border border-white/20 rounded-xl p-4 mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 print-items">
              {currentCodes.map((code) => (
                ...
                >
                  {/* QR Code - 2x2 inch when printed */}
                  <div className="flex justify-center mb-4 print-mb-0 print-qr-wrapper">
