      ...
      <div className="mb-10">
        ...
        <div className="max-w-md relative">
          <input
            ...
            className="w-full px-5 py-4 pl-12 border border-white/20 rounded-xl bg-black/50 backdrop-blur-sm text-white placeholder-white/40 focus:border-white focus:outline-none focus:ring-2 focus:ring-white/20 font-ubuntu-light transition-all duration-300 hover:border-white/40"
          />
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <button
                        ...
                        className="px-4 py-2 border border-white/30 rounded-xl text-white font-ubuntu-medium text-sm hover:bg-white hover:text-black transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-white/20"
                      >
                        View
                      </button>
                    </td>
