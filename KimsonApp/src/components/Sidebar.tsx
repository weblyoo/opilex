...
export const Sidebar = () => {
  ...
  return (
    <aside className="bg-black/80 backdrop-blur-xl border-r border-white/20 w-64 h-screen fixed left-0 top-0 pt-0 z-20 shadow-2xl">
      <div className="p-6 pt-6 h-full overflow-y-auto">
        <div className="flex items-center justify-center border-b border-white/20 w-full overflow-hidden pb-4">
          <Logo size={160} dark={true} style={{ width: '200px', height: '40px' }} />
        </div>
            ...
            return (
              <Link
                ...
                className={`
                  ...
                  ${isActive
                    ? 'bg-white text-black font-ubuntu-bold shadow-lg shadow-white/20 scale-105'
